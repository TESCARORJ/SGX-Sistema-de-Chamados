...
| Diferencial | 7 — Gerenciamento de Requisições | Portal guiado por catálogo, visualmente superior ao formulário genérico do GLPI — 92%, pendente homologação (revertida em 20/07/2026, ver seção 9) |
...
| 2 — Diferencial já avançado | 7, 4 | 92% e 94% — fechar homologação e ter a demo mais forte pronta cedo |
