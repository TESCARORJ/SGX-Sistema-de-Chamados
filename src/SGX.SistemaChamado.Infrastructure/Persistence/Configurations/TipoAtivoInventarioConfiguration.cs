...
public sealed class TipoAtivoInventarioConfiguration : IEntityTypeConfiguration<TipoAtivoInventario>
{
    public void Configure(EntityTypeBuilder<TipoAtivoInventario> builder)
    {
        builder.ToTable("tipos_ativo_inventario");
        ...
        builder.HasIndex(x => x.Nome).IsUnique().HasDatabaseName("ux_tipos_ativo_inventario_nome");

        builder.HasData(SeedData.TiposAtivoInventario);
    }
}
