...
namespace SGX.SistemaChamado.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260523165910_Sprint1CatalogoServicosFundacao")]
    partial class Sprint1CatalogoServicosFundacao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGX.SistemaChamado.Domain.Entities.RoadmapItsmItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AtencaoTecnica = "Catalogo institucional e multiarea com departamento responsavel obrigatorio e relacionamentos opcionais para nao bloquear evolucao",
                            Ativo = true,
                            Categoria = "Conhecimento",
                            CriadoEm = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CriadoPor = "seed.sistema",
                            CriterioAceite = "Fundacao tecnica do catalogo implementada com entidade, enums, mapeamento EF Core, migration, permissoes e documentacao inicial",
                            DataConclusaoTecnica = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Decisao = 2,
                            EvidenciaImplementacao = "docs/CATALOGO-SERVICOS.md; src/SGX.SistemaChamado.Domain/Entities/CatalogoServico.cs",
                            Impacto = 1,
                            Ordem = 12,
                            PendenciasHomologacao = "Validar fluxos com areas nao-TI apos entrega funcional das proximas sprints",
                            PendenciasTecnicas = "Implementar CRUD administrativo, publicacao/arquivamento operacional e regras de exposicao para solicitantes",
                            PercentualImplementacao = 20,
                            Prioridade = 2,
                            ProximaAcao = "Implementar sprint 2 com casos de uso e endpoints administrativos",
                            RoadmapCategoriaId = new Guid("66666666-6666-6666-6666-666666666614"),
                            SituacaoAtual = "Fundacao tecnica implementada",
                            Status = 3,
                            StatusImplementacao = 3,
                            StatusTecnico = 4
                        },
