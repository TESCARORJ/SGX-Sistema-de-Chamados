...
{
    /// <inheritdoc />
    public partial class ConcluirRegraDirecionarChamadoGrupoTecnicoSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 35, "Criar regra para assumir chamado da fila." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 33, "Modelar GrupoTecnico e regras de roteamento inicial." });
        }
    }
}
