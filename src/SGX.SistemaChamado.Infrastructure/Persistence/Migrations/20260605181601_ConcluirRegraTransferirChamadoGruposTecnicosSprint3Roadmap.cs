...
{
    /// <inheritdoc />
    public partial class ConcluirRegraTransferirChamadoGruposTecnicosSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 39, "Criar regra para atribuir chamado a tecnico especifico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 37, "Criar regra para transferir chamado entre grupos tecnicos." });
        }
    }
}
