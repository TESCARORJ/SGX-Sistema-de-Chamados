...
{
    /// <inheritdoc />
    public partial class ConcluirConsultasChamadosGrupoFilaSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 44, "Validar permissoes de acesso as operacoes de grupo e fila." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 43, "Ajustar consultas de chamados para considerar grupo tecnico e fila." });
        }
    }
}
