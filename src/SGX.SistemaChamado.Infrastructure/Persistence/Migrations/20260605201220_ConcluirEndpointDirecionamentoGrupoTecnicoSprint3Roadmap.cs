...
{
    /// <inheritdoc />
    public partial class ConcluirEndpointDirecionamentoGrupoTecnicoSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 52, "Criar endpoint para assumir chamado." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 50, "Criar endpoints de direcionamento para grupo." });
        }
    }
}
