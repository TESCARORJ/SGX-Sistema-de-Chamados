...
{
    /// <inheritdoc />
    public partial class ConcluirEndpointTransferenciaGrupoTecnicoSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 56, "Criar endpoint/listagem de fila por grupo tecnico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 54, "Criar endpoint para transferencia de chamado." });
        }
    }
}
