...
{
    /// <inheritdoc />
    public partial class ConcluirTelaCadastroGruposTecnicosSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 59, "Criar tela ou secao de membros por grupo tecnico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 57, "Criar tela ou secao de cadastro de grupos tecnicos." });
        }
    }
}
