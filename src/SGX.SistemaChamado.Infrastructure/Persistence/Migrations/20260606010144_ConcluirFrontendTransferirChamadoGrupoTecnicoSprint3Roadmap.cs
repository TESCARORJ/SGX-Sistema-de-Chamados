...
{
    /// <inheritdoc />
    public partial class ConcluirFrontendTransferirChamadoGrupoTecnicoSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 69, "Ajustar listagem/filtros para grupo tecnico e fila." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 67, "Permitir transferir chamado para outro grupo tecnico." });
        }
    }
}
