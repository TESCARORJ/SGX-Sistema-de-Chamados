...
{
    /// <inheritdoc />
    public partial class ConcluirTestesTransferenciaGruposTecnicosSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 80, "Testar preservacao do responsavel atual do chamado." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 78, "Testar transferencia entre grupos tecnicos." });
        }
    }
}
