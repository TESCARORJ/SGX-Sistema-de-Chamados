...
{
    /// <inheritdoc />
    public partial class ConcluirTestesRegressaoAberturaAtribuicaoChamadoSprint3Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 87, "Documentar modelo de grupo tecnico, filas e atribuicao." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777720"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 85, "Testar regressao do fluxo atual de abertura e atribuicao de chamado." });
        }
    }
}
