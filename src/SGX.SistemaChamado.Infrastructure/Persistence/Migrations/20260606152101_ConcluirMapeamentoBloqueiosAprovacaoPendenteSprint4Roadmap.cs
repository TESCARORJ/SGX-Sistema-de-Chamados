...
{
    /// <inheritdoc />
    public partial class ConcluirMapeamentoBloqueiosAprovacaoPendenteSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 6, "Definir conceito de motor de aprovacao ITSM reutilizavel." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 4, "Mapear pontos onde chamado deve ficar bloqueado por aprovacao pendente." });
        }
    }
}
