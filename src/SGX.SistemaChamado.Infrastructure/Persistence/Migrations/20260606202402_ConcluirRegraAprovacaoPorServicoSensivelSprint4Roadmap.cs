...
{
    /// <inheritdoc />
    public partial class ConcluirRegraAprovacaoPorServicoSensivelSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 12, "Definir regra de aprovacao por impacto e urgencia." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 10, "Definir regra de aprovacao por servico sensivel." });
        }
    }
}
