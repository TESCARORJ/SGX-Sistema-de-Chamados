...
{
    /// <inheritdoc />
    public partial class ConcluirRegraRejeicaoEncerramentoRetornoChamadoSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "pendencias_tecnicas", "percentual_implementacao", "proxima_acao" },
                values: new object[] { "Aprovacao por grupo, multi-nivel, aprovador padrao e bloqueio por decisao pendente.", 25, "Definir regra de rejeicao e encerramento ou retorno do chamado." });
        }
    }
}
