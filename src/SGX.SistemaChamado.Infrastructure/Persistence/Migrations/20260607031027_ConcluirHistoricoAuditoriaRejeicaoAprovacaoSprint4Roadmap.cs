...
{
    /// <inheritdoc />
    public partial class ConcluirHistoricoAuditoriaRejeicaoAprovacaoSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 32, "Definir historico e auditoria de rejeicao de aprovacao." });
        }
    }
}
