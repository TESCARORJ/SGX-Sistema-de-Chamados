...
{
    /// <inheritdoc />
    public partial class ConcluirCompatibilidadeChamadosExistentesSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 37, "Avaliar compatibilidade com fluxo atual de abertura de chamado." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 34, "Definir historico e auditoria de aprovacao expirada ou cancelada." });
        }
    }
}
