...
{
    /// <inheritdoc />
    public partial class ConcluirServicoAplicacaoInstanciaAprovacaoSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 53, "Criar servico de aplicacao para instancia de aprovacao." });
        }
    }
}
