...
{
    /// <inheritdoc />
    public partial class ConcluirRegraGerarAprovacaoObrigatoriaChamadoSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 56, "Criar regra para bloquear movimentacao com aprovacao pendente." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 54, "Criar regra para gerar aprovacao obrigatoria no chamado." });
        }
    }
}
