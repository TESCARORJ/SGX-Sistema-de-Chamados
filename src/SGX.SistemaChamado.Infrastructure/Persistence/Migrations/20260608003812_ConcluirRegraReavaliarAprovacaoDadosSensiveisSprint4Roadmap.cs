...
{
    /// <inheritdoc />
    public partial class ConcluirRegraReavaliarAprovacaoDadosSensiveisSprint4Roadmap : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 62, "Criar endpoints administrativos de regras de aprovacao." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777722"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 60, "Criar regra para reavaliar aprovacao apos mudanca de dados sensiveis." });
        }
    }
}
