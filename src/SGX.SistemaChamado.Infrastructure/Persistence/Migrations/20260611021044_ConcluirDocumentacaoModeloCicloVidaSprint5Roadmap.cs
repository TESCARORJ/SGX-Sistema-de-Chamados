...
{
    /// <inheritdoc />
    public partial class ConcluirDocumentacaoModeloCicloVidaSprint5Roadmap : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777724"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 13, "Evoluir estados e regras de negócio de ciclo de vida." });
        }
    }
}
