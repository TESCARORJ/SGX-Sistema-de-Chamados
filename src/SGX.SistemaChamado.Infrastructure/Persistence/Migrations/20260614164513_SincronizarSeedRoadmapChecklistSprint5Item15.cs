...
{
    /// <inheritdoc />
    public partial class SincronizarSeedRoadmapChecklistSprint5Item15 : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777724"),
                columns: new[] { "atencao_tecnica", "criterio_aceite", "objetivo", "pendencias_homologacao", "pendencias_tecnicas", "percentual_implementacao", "proxima_acao", "situacao_atual" },
                values: new object[] { "Separar conceitualmente e funcionalmente os estados Resolvido e Fechado. NÃ£o tratar resoluÃ§Ã£o como encerramento definitivo. Exigir dados obrigatÃ³rios de soluÃ§Ã£o para resoluÃ§Ã£o e motivo obrigatÃ³rio para cancelamento. Preservar compatibilidade com o fluxo legado, com SLA, com atendimento, com histÃ³rico, com permissÃµes administrativas e com o motor de aprovaÃ§Ãµes da Sprint 4. Nenhuma regra de fechamento deve ignorar aprovaÃ§Ã£o pendente bloqueante.", "Fluxo contempla resoluÃ§Ã£o, aceite/rejeiÃ§Ã£o pelo solicitante, fechamento automÃ¡tico por prazo, cancelamento com motivo obrigatÃ³rio, reabertura auditÃ¡vel e compatibilidade com SLA, histÃ³rico, permissÃµes e aprovaÃ§Ãµes pendentes bloqueantes.", "Criar governanÃ§a de encerramento com aceite, fechamento automÃ¡tico e reabertura controlada.", "Validar regras com solicitantes, atendentes e administradores reais, incluindo resoluÃ§Ã£o, aceite, rejeiÃ§Ã£o, fechamento automÃ¡tico, cancelamento e reabertura controlada.", "Aceite do solicitante, rejeiÃ§Ã£o da soluÃ§Ã£o, prazo de auto-fechamento, motivo de cancelamento, polÃ­tica formal de reabertura, auditoria do ciclo resolvido/fechado/reaberto e integraÃ§Ã£o segura com bloqueios de aprovaÃ§Ã£o pendente.", 44, "Registrar auditoria de resolucao, aceite, rejeicao, fechamento e reabertura.", "Encerrar e reabrir chamados jÃ¡ existem no sistema, mas o fluxo ainda nÃ£o possui governanÃ§a completa de aceite do solicitante, prazo formal de auto-fechamento, rejeiÃ§Ã£o de soluÃ§Ã£o, campos obrigatÃ³rios de soluÃ§Ã£o/cancelamento e polÃ­ticas auditÃ¡veis de reabertura." });
