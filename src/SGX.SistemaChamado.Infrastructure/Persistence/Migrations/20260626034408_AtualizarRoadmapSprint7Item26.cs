...
{
    /// <inheritdoc />
    public partial class AtualizarRoadmapSprint7Item26 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 77, "Testar formulario obrigatorio e respostas invalidas" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777718"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 74, "Testar abertura por catalogo com aprovacao obrigatoria" });
        }
    }
}
