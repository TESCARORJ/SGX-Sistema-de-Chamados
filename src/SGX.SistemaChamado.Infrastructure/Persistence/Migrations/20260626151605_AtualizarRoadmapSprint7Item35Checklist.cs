...
{
    /// <inheritdoc />
    public partial class AtualizarRoadmapSprint7Item35Checklist : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyColumn: "id",
                keyValue: new Guid("78787878-7878-7878-7878-000000010034"),
                column: "concluido",
                value: true);
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 90, "Criar migration de dados ou checklist, se aplicavel" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777718"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 87, "Criar ou revisar migrations estruturais, se necessarias" });
