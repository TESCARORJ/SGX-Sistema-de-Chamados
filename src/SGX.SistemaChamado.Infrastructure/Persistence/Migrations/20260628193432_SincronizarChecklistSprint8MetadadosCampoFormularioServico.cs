...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8MetadadosCampoFormularioServico : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 43, "Modelar opcoes de campos enumerados, se aplicavel." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 42, "Modelar obrigatoriedade, ordem, ajuda e visibilidade dos campos." });
        }
    }
}
