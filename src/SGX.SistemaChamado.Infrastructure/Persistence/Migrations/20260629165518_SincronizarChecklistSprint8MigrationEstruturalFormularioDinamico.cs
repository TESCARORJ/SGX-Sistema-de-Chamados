...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8MigrationEstruturalFormularioDinamico : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 49, "Ajustar contratos administrativos para manutencao de formulario do servico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 47, "Criar migration estrutural para formulario dinamico." });
        }
    }
}
