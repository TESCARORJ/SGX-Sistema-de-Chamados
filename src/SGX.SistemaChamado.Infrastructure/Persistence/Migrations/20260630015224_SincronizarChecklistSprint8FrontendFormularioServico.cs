...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8FrontendFormularioServico : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 55, "Testar configuracao administrativa de formulario por servico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 54, "Ajustar frontend administrativo do catalogo para configurar formulario." });
        }
    }
}
