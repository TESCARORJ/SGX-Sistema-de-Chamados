...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8ContratoRespostasFormularioAbertura : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 59, "Criar validator de respostas do formulario na abertura guiada." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 58, "Ajustar contrato de abertura guiada para receber respostas do formulario." });
        }
    }
}
