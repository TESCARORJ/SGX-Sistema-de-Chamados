...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8ObrigatoriedadeRespostasFormularioAbertura : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 61, "Validar obrigatoriedade dos campos no backend." });
        }
    }
}
