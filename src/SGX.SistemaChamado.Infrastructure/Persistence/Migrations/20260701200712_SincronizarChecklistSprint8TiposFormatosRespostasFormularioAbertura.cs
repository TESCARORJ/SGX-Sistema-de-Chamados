...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8TiposFormatosRespostasFormularioAbertura : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 63, "Impedir respostas de campos inexistentes ou de outro servico." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 62, "Validar tipos e formatos das respostas no backend." });
        }
    }
}
