...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8RenderizacaoFormularioPortal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 67, "Ajustar frontend do portal para enviar respostas do formulario." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 66, "Ajustar frontend do portal para renderizar formulario dinamico." });
        }
    }
}
