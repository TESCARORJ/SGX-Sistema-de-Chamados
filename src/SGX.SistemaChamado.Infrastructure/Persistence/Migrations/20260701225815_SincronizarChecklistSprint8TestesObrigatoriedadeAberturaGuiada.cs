...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8TestesObrigatoriedadeAberturaGuiada : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 71, "Testar abertura guiada com respostas invalidas." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 70, "Testar abertura guiada com campos obrigatorios ausentes." });
        }
    }
}
