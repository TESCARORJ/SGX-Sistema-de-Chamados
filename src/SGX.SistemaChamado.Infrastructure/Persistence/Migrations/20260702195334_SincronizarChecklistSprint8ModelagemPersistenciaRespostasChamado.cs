...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8ModelagemPersistenciaRespostasChamado : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 75, "Configurar EF Core para respostas do formulario." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 74, "Modelar persistencia das respostas do formulario no chamado." });
        }
    }
}
