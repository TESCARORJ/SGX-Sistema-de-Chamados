...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8ExibicaoRespostasFormularioDetalheChamado : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 80, "Exibir respostas do formulario no portal do solicitante." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 79, "Exibir respostas do formulario no detalhe do chamado." });
        }
    }
}
