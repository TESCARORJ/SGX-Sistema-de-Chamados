...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8TestesPersistenciaRespostasFormulario : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 87, "Testar exibicao das respostas no portal." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 86, "Testar persistencia das respostas do formulario." });
        }
    }
}
