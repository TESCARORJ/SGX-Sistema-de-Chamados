...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8ExibicaoRespostasAdmin : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 88, "Testar exibicao das respostas no atendimento administrativo." });
        }
    }
}
