...
{
    /// <inheritdoc />
    public partial class SincronizarChecklistSprint8AutorizacaoFormularioAdministrativo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { 92, "Garantir que solicitante nao manipule grupo, SLA, aprovacao ou classificacao." });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("77777777-7777-7777-7777-777777777719"),
                columns: new[] { "percentual_implementacao", "proxima_acao" },
                values: new object[] { 91, "Garantir autorizacao para manutencao administrativa do formulario." });
        }
    }
}
