...
public static class SeedData
{
    ...
    [
        ...
        new { Id = Guid.Parse("78787878-7878-7878-7878-000000000125"), RoadmapItemId = RoadmapItsmItem22Id, Titulo = "Planejar escopo e criterios de aceite", Descricao = "Sprint 4 Motor de Aprovacoes ITSM", Grupo = GrupoRoadmapChecklist.Planejamento, Ordem = 1, Concluido = true, Obrigatorio = true, Ativo = true, CriadoEm = DataBase, CriadoPor = UsuarioSistema, AtualizadoEm = (DateTime?)null, AtualizadoPor = (string?)null },
        new { Id = Guid.Parse("78787878-7878-7878-7878-000000000126"), RoadmapItemId = RoadmapItsmItem22Id, Titulo = "Implementar entregas centrais da sprint", Descricao = "Sprint 4 Motor de Aprovacoes ITSM", Grupo = GrupoRoadmapChecklist.Desenvolvimento, Ordem = 2, Concluido = true, Obrigatorio = true, Ativo = true, CriadoEm = DataBase, CriadoPor = UsuarioSistema, AtualizadoEm = (DateTime?)null, AtualizadoPor = (string?)null },
        new { Id = Guid.Parse("78787878-7878-7878-7878-000000000127"), RoadmapItemId = RoadmapItsmItem22Id, Titulo = "Executar testes funcionais e tecnicos", Descricao = "Sprint 4 Motor de Aprovacoes ITSM", Grupo = GrupoRoadmapChecklist.Testes, Ordem = 3, Concluido = false, Obrigatorio = true, Ativo = true, CriadoEm = DataBase, CriadoPor = UsuarioSistema, AtualizadoEm = (DateTime?)null, AtualizadoPor = (string?)null },
        new { Id = Guid.Parse("78787878-7878-7878-7878-000000000128"), RoadmapItemId = RoadmapItsmItem22Id, Titulo = "Registrar homologacao e aceite", Descricao = "Sprint 4 Motor de Aprovacoes ITSM", Grupo = GrupoRoadmapChecklist.Homologacao, Ordem = 4, Concluido = false, Obrigatorio = true, Ativo = true, CriadoEm = DataBase, CriadoPor = UsuarioSistema, AtualizadoEm = (DateTime?)null, AtualizadoPor = (string?)null },
