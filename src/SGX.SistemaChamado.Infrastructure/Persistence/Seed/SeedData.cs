...
public static class SeedData
{
    ...
    [
        ...
        new
        {
            ...
            RoadmapCategoriaId = RoadmapCategoriaItilId,
            SituacaoAtual = "Fluxo de requisicao via catalogo implementado, incluindo grupo responsavel, formulario dinamico por servico e persistencia das respostas.",
            AtencaoTecnica = "Nenhum debito tecnico pendente; falta apenas homologacao formal.",
            Status = StatusRoadmapItsm.Parcial,
            Prioridade = PrioridadeRoadmapItsm.Alta,
            Impacto = ImpactoRoadmapItsm.Alto,
            Decisao = DecisaoRoadmapItsm.DesenvolverAgora,
            ...
            EvidenciaImplementacao = "Grupo tecnico do catalogo, formulario dinamico por servico e persistencia/validacao das respostas implementados e cobertos por testes comportamentais (ver AbrirChamadoUseCaseTests).",
            DataConclusaoTecnica = (DateTime?)null,
            DataHomologacao = (DateTime?)null,
            CriterioAceite = "Requisicao nasce do Catalogo e aplica formulario, aprovacao, SLA e grupo responsavel.",
            ProximaAcao = "Registrar homologacao funcional, homologacao visual e aceite formal da Sprint 7 (itens 37-39).",
            Observacao = (string?)null,
            Responsavel = "Time Atendimento",
            PrazoAlvo = (DateTime?)null,
            Ordem = 50,
        ...
        new
        {
            ...
            StatusTecnico = StatusTecnicoRoadmapItsm.CompletoComPendenciasEvolutivas,
            PercentualImplementacao = 94,
            PendenciasTecnicas = "Nenhum debito tecnico pendente; falta apenas homologacao visual/manual e registro de aceite formal (item 16 do checklist).",
            ...
            ProximaAcao = "Executar homologacao visual/manual (320px/375px/768px/desktop) e registrar aceite formal da Sprint 6.",
            Observacao = (string?)null,
            Responsavel = "Time Produto",
            PrazoAlvo = (DateTime?)null,
            Ordem = 10,
