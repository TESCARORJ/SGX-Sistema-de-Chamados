...
public sealed class AlterarStatusChamadoUseCaseTests
{
    ...
    private static async Task<(Chamado Chamado, Guid StatusEmAtendimentoId, UsuarioContextoAplicacao AdminContexto)> SeedAsync(SGX.SistemaChamado.Infrastructure.Persistence.SGXSistemaChamadoDbContext context)
    {
        ...
        return (chamado, status.Id, AdminUseCasesTestFactory.Contexto(admin, "Administrador"));
    }
}
