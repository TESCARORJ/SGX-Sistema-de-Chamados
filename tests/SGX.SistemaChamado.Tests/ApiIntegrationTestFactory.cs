    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configBuilder) =>
        {
            configBuilder.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Authentication:Provedores:Configurados:1"] = "LocalDevelopment",
                ["Authentication:Provedores:Habilitados:0"] = "LocalSgx",
                ["Authentication:Provedores:Habilitados:1"] = "LocalDevelopment",
                ["Authentication:Provedores:Principal"] = "LocalSgx",
                ["Authentication:Provedores:Ordem:LocalSgx"] = "10",
                ["Authentication:Provedores:Ordem:LocalDevelopment"] = "20",
                ...
                ["Cors:AllowedOrigins:3"] = "https://127.0.0.1:5173",
                ["AzureAd:TenantId"] = "",
                ["AzureAd:ClientId"] = "",
                ["AzureAd:Audience"] = "",
                ["AzureAd:Issuer"] = "",
