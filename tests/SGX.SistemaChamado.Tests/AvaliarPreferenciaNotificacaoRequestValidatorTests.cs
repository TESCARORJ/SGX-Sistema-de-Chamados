...
public sealed class AvaliarPreferenciaNotificacaoRequestValidatorTests
{
    private readonly AvaliarPreferenciaNotificacaoRequestValidator _validator = new();
